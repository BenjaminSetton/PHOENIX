...
PHX_IncludeDirs["dep_shaderc"]       = "%{wks.location}/PHOENIX/vendor/shaderc-phx/libshaderc/include"
...
PHX_Libraries["shaderc"]             = "%{wks.location}/PHOENIX/vendor/shaderc-phx/out/bin/" .. outputDir .. "/shaderc.lib"