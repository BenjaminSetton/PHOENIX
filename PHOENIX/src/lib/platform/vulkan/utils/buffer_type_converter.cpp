...
namespace PHX
{
	namespace BUFFER_UTILS
	{
		VkBufferUsageFlags ConvertBufferUsage(BUFFER_USAGE usage)
		{
			...
			case BUFFER_USAGE::ACCELERATION_STRUCTURE_BUILD_INPUT: return VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT | VK_BUFFER_USAGE_STORAGE_BUFFER_BIT;
			}
