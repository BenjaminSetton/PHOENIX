...
namespace PHX
{
	...
	namespace TEX_UTILS
	{
		VkFormat ConvertBaseFormat(BASE_FORMAT format)
		{
			...
			case BASE_FORMAT::B8G8R8A8_UNORM:		return VK_FORMAT_B8G8R8A8_UNORM;
			case BASE_FORMAT::BC1_RGB_UNORM:		return VK_FORMAT_BC1_RGB_UNORM_BLOCK;
			case BASE_FORMAT::BC1_RGB_SRGB:			return VK_FORMAT_BC1_RGB_SRGB_BLOCK;
			case BASE_FORMAT::BC1_RGBA_UNORM:		return VK_FORMAT_BC1_RGBA_UNORM_BLOCK;
			case BASE_FORMAT::BC1_RGBA_SRGB:		return VK_FORMAT_BC1_RGBA_SRGB_BLOCK;
			case BASE_FORMAT::BC3_UNORM:			return VK_FORMAT_BC3_UNORM_BLOCK;
			case BASE_FORMAT::BC3_SRGB:				return VK_FORMAT_BC3_SRGB_BLOCK;
			case BASE_FORMAT::BC4_UNORM:			return VK_FORMAT_BC4_UNORM_BLOCK;
			case BASE_FORMAT::BC4_SNORM:			return VK_FORMAT_BC4_SNORM_BLOCK;
			case BASE_FORMAT::BC5_UNORM:			return VK_FORMAT_BC5_UNORM_BLOCK;
			case BASE_FORMAT::BC5_SNORM:			return VK_FORMAT_BC5_SNORM_BLOCK;
			case BASE_FORMAT::BC6H_UFLOAT:			return VK_FORMAT_BC6H_UFLOAT_BLOCK;
			case BASE_FORMAT::BC6H_SFLOAT:			return VK_FORMAT_BC6H_SFLOAT_BLOCK;
			case BASE_FORMAT::BC7_UNORM:			return VK_FORMAT_BC7_UNORM_BLOCK;
			case BASE_FORMAT::BC7_SRGB:				return VK_FORMAT_BC7_SRGB_BLOCK;
			}
