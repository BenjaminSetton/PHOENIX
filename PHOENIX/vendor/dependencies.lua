...
PHX_IncludeDirs["dep_slang"]                         = "%{wks.location}/PHOENIX/vendor/slang/include"
...
PHX_Libraries["slang"]                               = "%{wks.location}/PHOENIX/out/slang/bin/%{cfg.system}/%{slangConfigLower[cfg.buildcfg]}/%{cfg.architecture}/slang-compiler%{ConfigMap.debugSuffix[cfg.buildcfg]}.lib"
