...
namespace PHX
{
	...
	void QueueFamilyIndices::SetIndex(QUEUE_TYPE type, u32 index)
	{
	...
	u32 QueueFamilyIndices::GetIndex(QUEUE_TYPE type) const
	{
	...
	bool QueueFamilyIndices::IsValid(u32 index) const
	{
	...
	QueueFamilyIndices FindQueueFamilies(VkPhysicalDevice device, VkSurfaceKHR surface)
	{
		...
		if (!indices.IsValid(static_cast<u32>(QUEUE_TYPE::TRANSFER)) && graphicsTransferQueue != QueueFamilyIndices::INVALID_INDEX)
		{
