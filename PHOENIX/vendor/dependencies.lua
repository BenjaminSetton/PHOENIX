...
PHX_IncludeDirs["dep_shaderc"]       = "%{wks.location}/PHOENIX/vendor/shaderc/libshaderc/include"
...
PHX_Libraries["shaderc"]             = "%{wks.location}/PHOENIX/vendor/shaderc/out/bin/" .. outputDir .. "/shaderc.lib"