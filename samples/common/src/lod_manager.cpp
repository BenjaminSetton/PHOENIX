...
namespace Common
{
	...
	void LodManager::UploadStaticData(PHX::RenderGraphHandle renderGraph, PHX::SwapChainHandle swapChain)
	{
	...
	void LodManager::UploadInstances(PHX::RenderGraphHandle renderGraph, PHX::SwapChainHandle swapChain)
	{
	...
	void LodManager::ZeroDrawBuffers(PHX::RenderGraphHandle renderGraph, PHX::SwapChainHandle swapChain)
	{
	...
	void LodManager::CullAndSelectGPU(PHX::DeviceContextHandle deviceContext,
		PHX::UniformCollectionHandle computeUniforms,
		const LodCameraData& cameraData,
